...
<div class="wrapper">
    ...
    <div class="dropdown1">
        ...
        <div class="wrapper1">
          ...
          <div class="searchresults" style="margin-left: 30%; margin-top:5%">
                
               
                <centre><table id="tran" class="table table-dark hover" style="color: black;">
                  ...
                  <?php
                    ...
                    if(isset($_GET['submit']))
                    {
                        ...
                        if($var === 'book_name')
                        {
                          $query="select * from book where title='$b'";
                        }
              ...
              <tr style= "border: 1px solid black;">
                <td><centre><?php echo $row['book_id'] ?></centre></td>
                <centre><td><?php echo $row['title'] ?></td></centre>
                <centre><td><?php echo $row['author'] ?></td></centre>
                <centre><td><?php echo $row['publisher'] ?></td></centre>
                <centre><td><?php echo $row['copies'] ?></td></centre>
                <td><form style="width:100%;" action="deletebook.php" method="post"><button class="btn btn-dark" style="width:90%;color:white; background-color:black;" name='del' type="submit" value="<?php echo $row['book_id']?>">Delete</button></form></td>
              ...
              ?>
                ...
                <?php
                    ...
                    {
                        $query=$_POST['del'];
                        $s="delete from book where book_id='$query'";
