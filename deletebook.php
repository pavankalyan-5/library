          ...
          <div id="content" style="display: block;">
            ...
            <div id="search"  >
              <form action="deletebook.php" method="post">
                <input type="text" placeholder="enter book name" required style="width:30% " name="bname">
              ...
              <tr  style= "border: 1px solid black;">
                ...
                <td><form action="deletebook.php" method="post"><button name='del' type="submit" value="<?php echo $row['book_id']?>">Delete</button></form></td>
