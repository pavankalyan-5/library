  ...
  <body style="background-size:cover;background-repeat:no-repeat; background-attachment:fixed;">
    ...
    <div class="wrapper">
        ...
        <ul>
            ...
            <li><a href="fine.php"><i style="padding-right:10px;font-size: 18px;"class="fas fa-rupee-sign"></i>Fine</a></li>
     ...
     ?>
      <div class="wrapper1">
        <div class="left">
          ...
          <h4><?php  echo $_SESSION['stu_reg']?></h4>
      </div>
          ...
          <div class="info" style="width: 100%;">
              ...
              <div class="info_data" style="width: 100%;">
                <div class="data" style="width: 100%;">
                      ...
                      <h4>Year:</h4>
                        <p><?php  echo strval(substr(date("Y"),2))-strval(substr($row['regno'],1,2))?></p>
                        <h4>Branch:</h4>
                        <p><?php  
                        $va=substr($row['regno'],-5,-3);
                        if($va=='10')
                        echo 'CSE';
                        else if($va=='12')
                        echo 'ECE';
      ...
      <form action="profile.php" onsubmit="return validateImage();"name="update" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name='user' id="user" value="<?php  echo $row['name']?>" placeholder="enter name" >
            </div>
            <div class="form-group">
              <label class="form-label" style="color: black;">Email</label>
              <input type="email" class="form-control" name='email' id="email" value="<?php  echo $row['email']?>" placeholder="enter email" >
            </div>
            <div class="form-group">
      ...
      <form name='change' action="" method="POST">
        ...
        <div class="modal-footer">
          ...
          <?php
            ...
            {
              $before=$row['regno'];
              $bef_pass=$row['password'];
              $new_cur=$_POST['curpass'];
              $new_pass=$_POST['newpass'];
              $connew_pass=$_POST['connewpass'];
              $query="update login set password='$new_pass' where regno= '$before'";
...
<?php
            ...
            if(isset($_POST['submit']))
            {
              ...
              $_SESSION['stu_name']=$modified_name;
              $modified_email=$_POST['email'];
              $query="update login set name='$modified_name', email='$modified_email' where regno= '$before'";
              $res=mysqli_query($con,$query);
              echo '<script>window.location.href="profile.php"</script>';
            }
              ...
              if ($error == 0) {
                if ($img_size > 1024000) {
                  ...
                  if (in_array($img_ex_lc, $allowed_exs)) {
                    ...
                    $user=$_SESSION['stu_reg'];
                    $query="update login set image='$new_img_name' where regno= '$user'";
